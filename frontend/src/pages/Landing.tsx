...
export default function Landing() {
  return (
    <section className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-purple-600/20 via-pink-600/10 to-cyan-500/20 p-8 md:p-12">
      ...
      <div className="max-w-3xl space-y-4">
        ...
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight">
          Trade AI tokens with beautiful quotes, charts, and analytics
        </h1>
      ...
      <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="rounded-xl border bg-background/60 p-4">
          ...
          <div className="text-2xl font-semibold">Cached + realtime</div>
        </div>
      </div>
    </section>
  );
